...
<pre><span class="kw">from</span> agent_framework <span class="kw">import</span> InlineSkill, InlineSkillResource
...
skill = InlineSkill(
    ...
    resources=[
        InlineSkillResource(
            ...
            mime_type=<span class="st">"text/plain"</span>,
        ),
    ],
)</pre>
</div>
...
skill = InlineSkill(name=<span class="st">"..."</span>, resources=[...])
